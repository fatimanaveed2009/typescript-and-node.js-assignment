...
const album1 = make_album('artistname 1', 'albumtitle 1')
console.log(album1);

const album2 = make_album('artistname 2', 'albumtitle 2')
console.log(album2);

const album3 = make_album('artistname 3', 'albumtitle 3',12)
console.log(album3);
