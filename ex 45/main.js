...
function storeCarInfo(manufecturer, modelName) {
    var extraOption = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        extraOption[_i - 2] = arguments[_i];
    }
    var carInfo = __assign({ manufecturer: manufecturer, modelName: modelName }, Object.assign.apply(Object, __spreadArray([{}], extraOption, false)));
    return carInfo;
}
;
var answare = storeCarInfo('Honda', 'Civic', { color: 'black' }, { features: ['Naigation', 'Power window'] });
console.log(answare);
